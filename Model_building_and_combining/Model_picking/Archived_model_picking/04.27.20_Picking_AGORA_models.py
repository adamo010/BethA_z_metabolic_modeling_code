...
otus = pd.read_csv("04.27.20_otu_table_abundance_filtered_0.1.csv") #this is the new contaminant-free table
...
otus_with_models_V1.to_csv("04.27.20_OTUs_with_models_V1.csv")
otus_with_models_V2.to_csv("04.27.20_OTUs_with_models_V2.csv")
otus_with_low_tax_ids.to_csv("04.27.20_OTUs_with_low_tax_ids.csv")
otus_without_family_models.to_csv("04.27.20_OTUs_without_models_V1.csv")
otus_without_family2_models.to_csv("04.27.20_OTUs_without_models_V2.csv")
