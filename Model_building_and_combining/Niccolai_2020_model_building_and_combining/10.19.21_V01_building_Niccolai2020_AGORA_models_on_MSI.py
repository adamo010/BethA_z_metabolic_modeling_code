...
def main():
    ...
    agora_model_file_dict = dict(zip(all_agora_merged_condensed2.OTU_ID,all_agora_merged_condensed2.all_agora_model_file_names.apply(lambda x: literal_eval(str(x)))))    
