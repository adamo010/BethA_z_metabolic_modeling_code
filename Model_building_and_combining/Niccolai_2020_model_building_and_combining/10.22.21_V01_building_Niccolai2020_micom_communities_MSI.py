...
def main():
    ...
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Niccolai_models/OTU_abundances_and_models/")	
    ...
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Niccolai_models/OTU_models") #directory where otu models live
