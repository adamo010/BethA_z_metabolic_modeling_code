...
####Fixing up V1
agora_V1 = pd.read_csv("10.19.21_Niccolai2020_OTUs_with_models_V2_indiv_specific_comms_V3.csv")   
#make a list of the columns which need nans replaced with blank lists
list_of_cols = ["family_matched_model_list", "genus2_matched_model_list"]
...
agora_V1['genus_matched_model_list'] = agora_V1.genus2_matched_model_list.apply(lambda x: literal_eval(str(x)))
...
agora_V1 = agora_V1.drop(columns=["Unnamed: 0", 'class_level_sort','family_level_sort','family_matched_model_list',\
                                  'genus2_matched_model_list','genus_level_sort','genus_matched_model_list',\
...
####Fixing up V2
agora_V2 = pd.read_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_fg_level_picks_V3.csv")
...
agora_V2 = agora_V2.drop(columns=["Unnamed: 0", 'agora_fg2_matched_model_list','agora_fg_matched_model_list',\
                                  'class_level_sort','family_level_sort','fg_level_sort','genus_level_sort',\
...
####Fixing up V3
agora_V3 = pd.read_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_picks_V3.csv")
sorted(agora_V3)
...
agora_V3 = agora_V3.drop(columns=["Unnamed: 0", 'agora_family_matched_model_list','agora_genus2_matched_model_list',\
                                  'agora_genus_matched_model_list','class_level_sort','family_level_sort','genus_level_sort',\
                                      'order_level_sort','phylum_level_sort'])
#however, do still need to convert all_agora_models column to list
agora_V3['all_agora_matched_models'] = agora_V3.all_agora_matched_models.apply(lambda x: literal_eval(str(x)))

####Fixing up V4
agora_V4 = pd.read_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_hand_picks_V3.csv")
sorted(agora_V4)
#for V3, already have an all_models column. so, can delete other matched_model_list columns. 
agora_V4 = agora_V4.drop(columns=['Unnamed: 0','agora_family_matched_model_list', 'all_agora_matched_models',\
                                  'agora_genus2_matched_model_list','agora_genus_matched_model_list','all_mambo_matched_models',\
                                      'class_level_sort','family_level_sort','genus_level_sort','hand_assigned_family',\
                                          'mambo_family_matched_model_list','mambo_genus_extracted_matched_model_list',\
                                              'mambo_genus_new_matched_model_list','order_level_sort','phylum_level_sort'])
...
#for this dataset, we are NOT doing MAMBO models, as none of them matched. Code is below.

####Step 3: All CarveMe models
carveme = pd.read_csv("10.19.21_Niccolai2020_OTUs_with_carveme_models.csv")
sorted(carveme)
carveme= carveme.drop(columns=["Unnamed: 0", 'agora_family_matched_model_list_hand_assigned','carveme_family_matched_model_list',\
                               'carveme_genus_matched_model_list','class_level_sort','family_level_sort','genus_level_sort',\
                                   'hand_assigned_family','mambo_family_matched_model_list_hand_assigned','order_level_sort','phylum_level_sort',])
...
all_agora_merged_condensed.to_pickle('Niccolai2020_AGORA_models_that_need_OTU_builds.pickle')
...
carveme.to_pickle("Niccolai2020_CarveMe_models_that_need_otu_builds.pickle")
...
################subsetting files
os.chdir("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_building_and_combining/Niccolai_2020_model_building_and_combining")
...
#all right, now we have 421 OTUs. Can probaby break this into two subsets and get away with it.
agora_subset1 = agora_subset.iloc[:210,:]
agora_subset2 = agora_subset.iloc[210:,:]
#save pickle files
agora_subset1.to_pickle('Niccolai2020_AGORA_models_that_need_OTU_builds_subset1.pickle')
agora_subset2.to_pickle('Niccolai2020_AGORA_models_that_need_OTU_builds_subset2.pickle')
