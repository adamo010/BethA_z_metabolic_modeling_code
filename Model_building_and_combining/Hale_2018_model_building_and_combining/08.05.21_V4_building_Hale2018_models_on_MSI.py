...
def main():
    ...
    mambo_model_file_dict = dict(zip(all_mambo_merged_condensed2.OTU_proxy_ID, \
                                 all_mambo_merged_condensed2.all_mambo_matched_models_x.apply(lambda x: literal_eval(str(x)))))    
    carveme_model_file_dict = dict(zip(carveme2.OTU_proxy_ID, \
                                 carveme2.all_carveme_matched_models.apply(lambda x: literal_eval(str(x)))))    
