...
def main():
    ...
    abundance_file_sample_prename = str(abundance_file)
    abundance_file_sample_name = abundance_file_sample_prename.replace("_abundances_and_models.csv", "")
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Muehlbauer_models/OTU_abundances_and_models/")	
    ...
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Muehlbauer_models/OTU_models") #directory where otu models live
    sample_community = Community(abundance_dataframe, solver='gurobi')
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Muehlbauer_models/Muehlbauer2021_pickle_files/")
