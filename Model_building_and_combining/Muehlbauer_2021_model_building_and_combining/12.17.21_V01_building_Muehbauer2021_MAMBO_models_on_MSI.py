...
def main():
    ...
    mambo_model_file_dict = dict(zip(all_mambo_merged_condensed2.OTU_ID,all_mambo_merged_condensed2.all_mambo_matched_models.apply(lambda x: literal_eval(str(x)))))    
    os.chdir("/panfs/roc/groups/7/blekhman/adamo010/Combining_Muehlbauer_models/MAMBO_models/")
