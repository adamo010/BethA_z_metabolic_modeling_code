...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Niccolai_2020_model_picking/10.19.21_Niccolai2020_OTUs_without_MAMBO_models_V1_indiv_specific_comms_V3.csv") 
...
otus_clean = otus.drop(columns=['agora_fg2_matched_model_list', 'agora_fg_matched_model_list', 'all_agora_matched_models',\
                                'all_mambo_matched_models', 'fg_level_sort', 'mambo_fg2_matched_model_list',\
...
#save our output:
otus_with_agora_models.to_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_fg_level_picks_V3.csv")
otus_with_agora_models2.to_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_picks_V3.csv")
otus_without_mambo_models2.to_csv("10.19.21_Niccolai2020_OTUs_without_models_after_fg_and_single_tax_level_picking_V3.csv")
...
model_matched_families_dict = {'Bacillaceae 1': 'Bacillaceae',\
                          'Clostridiaceae 1': 'Clostridiaceae', 'Clostridiaceae 2': 'Clostridiaceae',\
                              'Peptococcaceae 1': 'Peptococcaceae', 'Verrucomicrobiaceae': 'Akkermansiaceae'}
...
otus_with_hand_matched_agora_models.to_csv("10.19.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_hand_picks_V3.csv")
...
otus_with_hand_matched_mambo_models.to_csv("10.19.21_Niccolai2020_OTUs_with_mambo_models_single_tax_level_hand_picks_V3.csv")
otus_without_hand_matched_mambo_models.to_csv("10.19.21_Niccolai2020_OTUs_without_mambo_models_single_tax_level_hand_picks_V3.csv")
