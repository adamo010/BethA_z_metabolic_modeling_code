...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Contaminant_removal/10.15.21_Niccolai2020_otu_table_abundance_filtered_0.1_any_sample_cutoff.csv") #this is the new contaminant-free table
...
otus_with_models_V1.to_csv("10.15.21_Niccolai2020_OTUs_with_models_V1_indiv_specific_comms_newcontams.csv")
otus_with_models_V2.to_csv("10.15.21_Niccolai2020_OTUs_with_models_V2_indiv_specific_comms_newcontams.csv")
otus_with_low_tax_ids.to_csv("10.15.21_Niccolai2020_OTUs_with_low_tax_ids_newcontams.csv")
otus_without_family_models.to_csv("10.15.21_Niccolai2020_OTUs_without_models_V1_indiv_specific_comms_newcontams.csv") 
otus_without_family2_models.to_csv("10.15.21_Niccolai2020_OTUs_without_models_V2_indiv_specific_comms_newcontams.csv") 
