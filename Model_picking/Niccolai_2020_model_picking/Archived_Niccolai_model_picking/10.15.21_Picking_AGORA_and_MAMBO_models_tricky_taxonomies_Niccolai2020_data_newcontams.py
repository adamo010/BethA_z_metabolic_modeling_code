...
@author: adamo010
"""
#The goal here is to match AGORA and MAMBO models to OTUs from Niccolai2020 data.
...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Niccolai_2020_model_picking/10.15.21_Niccolai2020_OTUs_without_MAMBO_models_V1_indiv_specific_comms_newcontams.csv") 
...
list_of_cols = ["agora_fg_matched_model_list", "agora_fg2_matched_model_list"]
...
otus_plus_tax_plus_models["all_agora_matched_models"] = otus_plus_tax_plus_models["agora_fg_matched_model_list"] + \
        otus_plus_tax_plus_models["agora_fg2_matched_model_list"]
...
#first, fill in nan values with blank lists.
#make a list of the columns which need nans replaced with blank lists
list_of_cols2 = ["mambo_fg_matched_model_list", "mambo_fg2_matched_model_list"]
...
#create a new column. all_agora_matched_models, that contains a merged list of all matched models at all levels
otus_plus_tax_plus_models2["all_mambo_matched_models"] = otus_plus_tax_plus_models2["mambo_fg_matched_model_list"] + \
        otus_plus_tax_plus_models2["mambo_fg2_matched_model_list"] 
...
del otus, col, list_of_cols, list_of_cols2, agora_fg2_models_dict, agora_fg_models_dict, mambo_fg2_models_dict, mambo_fg_models_dict,\
    otus_plus_tax, otus_plus_tax2, otus_plus_tax_plus_models, otus_plus_tax_plus_models2, otus_with_mambo_models, unique_otu_ids,\
        unique_otu_ids2, otus_to_genus_level, otus_to_family_level
...
sorted(otus)
otus_clean = otus.drop(columns=['agora_fg2_matched_model_list', 'agora_fg_matched_model_list', 'all_agora_matched_models',\
                                'all_mambo_matched_models','family_level_sort', 'fg_level_sort', 'mambo_fg2_matched_model_list',\
                                    'mambo_fg_matched_model_list'])
...
#first, fill in nan values with blank lists.
#make a list of the columns which need nans replaced with blank lists
list_of_cols = ["agora_family_matched_model_list", "agora_genus_matched_model_list", "agora_genus2_matched_model_list"]
...
#save our output:
otus_with_agora_models.to_csv("10.15.21_Niccolai2020_OTUs_with_agora_models_fg_level_picks_newcontams.csv")
otus_with_agora_models2.to_csv("10.15.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_picks_newcontams.csv")
otus_without_mambo_models2.to_csv("10.15.21_Niccolai2020_OTUs_without_models_after_fg_and_single_tax_level_picking_newcontams.csv")
...
model_matched_families_dict = {'Bacillaceae 1': 'Bacillaceae',\
                          'Clostridiaceae 1': 'Clostridiaceae', 'Clostridiaceae 2': 'Clostridiaceae',\
                              'Peptococcaceae 1': 'Peptococcaceae'}
...
otus_with_hand_matched_agora_models.to_csv("10.15.21_Niccolai2020_OTUs_with_agora_models_single_tax_level_hand_picks.csv")
...
otus_with_hand_matched_mambo_models.to_csv("10.15.21_Niccolai2020_OTUs_with_mambo_models_single_tax_level_hand_picks.csv")
otus_without_hand_matched_mambo_models.to_csv("10.15.21_Niccolai2020_OTUs_without_mambo_models_single_tax_level_hand_picks.csv")
