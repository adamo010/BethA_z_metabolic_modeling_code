...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Niccolai_2020_model_picking/10.14.21_Niccolai2020_OTUs_without_models_V2_indiv_specific_comms.csv") #this is the new contaminant-free table
...
otus_plus_tax = otus_plus_tax.drop(columns={"Unnamed: 0", "genus2_matched_model_list", "family_matched_model_list"})
...
otus_with_models_V1.to_csv("10.14.21_Niccolai2020_OTUs_with_MAMBO_models_V1_indiv_specific_comms.csv")
otus_with_models_V2.to_csv("10.14.21_Niccolai2020_OTUs_with_MAMBO_models_V2_indiv_specific_comms.csv")
otus_with_low_tax_ids.to_csv("10.14.21_Niccolai2020_OTUs_with_MAMBO_low_tax_ids.csv")
otus_without_family_models.to_csv("10.14.21_Niccolai2020_OTUs_without_MAMBO_models_V1_indiv_specific_comms.csv") 
otus_without_family2_models.to_csv("10.14.21_Niccolai2020_OTUs_without_MAMBO_models_V2_indiv_specific_comms.csv") 
