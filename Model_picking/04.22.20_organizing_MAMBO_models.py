...
#this used to be called 04.14.20_pulling_non_AGORA_models; this is the preliminary work for the MAMBO database to get a csv file that I can
#then go into and look up the phylogenies by hand. 
...
onlyfiles = [f for f in listdir("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/MAMBO_models") if isfile(join("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/MAMBO_models", f))]
...
mambo_model_table.to_csv("04.14.20_MAMBO_model_spp_for_id.csv")
