...
carveme = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/07.29.21_Hale2018_Carved_model_taxonomy.csv")
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Hale_2018_model_picking/07.26.21_Hale2018_OTUs_without_mambo_models_single_tax_level_hand_picks.csv") 

#really need to clear out excess columns- there are too many
sorted(otus) #prints column names
otus_clean = otus.drop(columns=["Unnamed: 0", 'agora_family_matched_model_list', 'agora_family_matched_model_list_hand_assigned',\
                                'agora_genus2_matched_model_list', 'agora_genus_matched_model_list', 'agora_species_matched_model_list',\
                                    'all_agora_matched_models', 'all_mambo_matched_models','mambo_family_matched_model_list',\
                                        'mambo_family_matched_model_list_hand_assigned', 'mambo_genus_extracted_matched_model_list',\
...
#SAVE
otus_with_carveme_models.to_csv("07.29.21_Hale2018_OTUs_with_carveme_models.csv")
