...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 13 11:21:44 2021
...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Contaminant_removal/07.13.21_Hale2018_otu_table_abundance_filtered_0.1_any_sample_cutoff.csv") #this is the new contaminant-free table
...
#this creates a dataframe where a list of models matching each unique_agora_species can be added. 
...
otus_with_models_V1.to_csv("07.13.21_Hale2018_OTUs_with_models_V1_indiv_specific_comms.csv")
otus_with_models_V2.to_csv("07.13.21_Hale2018_OTUs_with_models_V2_indiv_specific_comms.csv")
otus_with_low_tax_ids.to_csv("07.13.21_Hale2018_OTUs_with_low_tax_ids.csv")
otus_without_family_models.to_csv("07.13.21_Hale2018_OTUs_without_models_V1_indiv_specific_comms.csv") 
otus_without_family2_models.to_csv("07.13.21_Hale2018_OTUs_without_models_V2_indiv_specific_comms.csv") 
