...
#update from 04.13.20: used to be called Building_microbiome_communities_03.25.20.py. Note also that this adds in 
...
otus = pd.read_csv("04.13.20_Burns_2015_OTUS_contaminants_removed.csv") #this is the new contaminant-free table
...
##############################added from Building_microbiome_communities_take2_03.26.20.py
...
###new for 03.26.20 edits
otus_to_gs_level = copy.deepcopy (otus_to_species_level)  #use species-level ided otus to create a genus-species (only) column
otus_to_gs_level["genus_species_level_sort"] = otus_to_gs_level['genus'] + ";" + otus_to_gs_level['species']
#11/10
...
genus_species_matched_models = copy.deepcopy(otus_to_gs_level)      #i am new for 03.26.20 edits
...
genus_species_matched_models['species_level_sort'] = genus_species_matched_models['species_level_sort'].str.strip()
genus_species_matched_models['genus_level_sort'] = genus_species_matched_models['genus_level_sort'].str.strip()
genus_species_matched_models['family_level_sort'] = genus_species_matched_models['family_level_sort'].str.strip()
#the line below is new, to account for changes from 03.26.20
genus_species_matched_models['genus_species_level_sort'] = genus_species_matched_models['genus_species_level_sort'].str.strip()
...
####step 10: ADDED from 03.26.20 take2: prepare gs-level model lists (need 2, for genus/species and genus2/species2)
genus_species2_matched_models = copy.deepcopy(genus_species_matched_models)

####step 11: ADDED from 03.26.20 take2: append modelless family-level otus to genus-species dataframe
genus_species_matched_models = genus_species_matched_models.append(no_family_models, ignore_index = True)
genus_species2_matched_models = genus_species2_matched_models.append(no_family2_models, ignore_index = True)

####step 12: ADDED from 03.26.20 take2: map gs models to family-level OTUs without models
genus_species_matched_models['gs_matched_model_list'] = genus_species_matched_models['genus_species_level_sort'].map(genus_spp_models_dict)     
genus_species2_matched_models['gs_matched_model_list'] = genus_species2_matched_models['genus_species_level_sort'].map(genus_spp2_models_dict)     
...
otus_with_gs_models = genus_species_matched_models[genus_species_matched_models['gs_matched_model_list'].notnull()]
otus_with_gs2_models = genus_species2_matched_models[genus_species_matched_models['gs_matched_model_list'].notnull()]

#fuck it. otus_with_gs_models and otus_with_gs2_models are blank
...
###########################from 03.26.20
#add a new column to match on 
otus_without_family_models["genus_species"] = otus_without_family_models['genus'] + "; " + otus_without_family_models['species']
otus_without_family2_models["genus_species2"] = otus_without_family2_models['genus'] + "; " + otus_without_family2_models['species']

otus_without_family_models["genus_species"] = otus_without_family_models["genus_species"].str.strip()
otus_without_family2_models["genus_species2"] = otus_without_family2_models["genus_species2"].str.strip()

otus_without_family_models['genus_species_model_list'] = otus_without_family_models['genus_species'].map(genus_spp_models_dict)        
otus_without_family2_models['genus_species2_model_list'] = otus_without_family2_models['genus_species2'].map(genus_spp2_models_dict)        

#pull out the assigned otus
otus_with_gs_models_V1 = otus_without_family_models[otus_without_family_models['genus_species_model_list'].notnull()]   
otus_with_gs_models_V2 = otus_without_family2_models[otus_without_family2_models['genus_species2_model_list'].notnull()]   
###########################

#concatenate (2step process)
V1 = [otus_with_models_V1, otus_with_gs_models_V1]
all_V1 = pd.concat(V1)
V2 = [otus_with_models_V2, otus_with_gs_models_V2]
all_V2 = pd.concat(V2)

all_V1.to_csv("04.13.20_OTUs_with_models_V1.csv")
all_V2.to_csv("04.13.20_OTUs_with_models_V2.csv")

#pull out the otus that still don't have assigned models
otus_with_low_tax_ids = otus[otus['family'].isnull() & otus['genus'].isnull() & otus['species'].isnull()]   
otus_wo_gs_models_V1 = otus_without_family_models[otus_without_family_models['genus_species_model_list'].isnull()]   
otus_wo_gs_models_V2 = otus_without_family2_models[otus_without_family2_models['genus_species2_model_list'].isnull()]   

wo_models = [otus_wo_gs_models_V1, otus_with_low_tax_ids]
otus_without_models = pd.concat(wo_models)
otus_without_models.to_csv("04.13.20_OTUs_without_models_V1.csv")
wo_models2 = [otus_wo_gs_models_V2, otus_with_low_tax_ids]
otus_without_models2 = pd.concat(wo_models2)
otus_without_models2.to_csv("04.13.20_OTUs_without_models_V2.csv")
...
otus_with_models_V1.to_csv("03.26.20_OTUs_with_models_V1.csv")


otus_with_models_V2.to_csv("03.26.20_OTUs_with_models_V2.csv")
...
otus_without_models = pd.concat(wo_models)
otus_without_models.to_csv("03.26.20_OTUs_without_models_V1.csv")
wo_models2 = [otus_without_family2_models, otus_with_low_tax_ids]
otus_without_models2 = pd.concat(wo_models2)
otus_without_models2.to_csv("03.26.20_OTUs_without_models_V2.csv")
