...
otus = pd.read_csv("04.13.20_OTUs_without_models_V1.csv") #at least V1 and V2 are identical
...
otus_with_models_V1.to_csv("04.14.20_OTUs_with_mambo_models_V1.csv")

V2_list = [otus_with_species2_models, otus_with_genus2_models, otus_with_family2_models]
otus_with_models_V2 = pd.concat(V2_list)
otus_with_models_V2.to_csv("04.14.20_OTUs_with_mambo_models_V2.csv")
...
otus_without_models.to_csv("04.14.20_OTUs_without_mambo_models_V1.csv")
wo_models2 = [otus_without_family2_models, otus_with_low_tax_ids]
otus_without_models2 = pd.concat(wo_models2)
otus_without_models2.to_csv("04.14.20_OTUs_without_mambo_models_V2.csv")
