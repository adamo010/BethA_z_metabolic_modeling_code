...
otus = pd.read_csv("05.01.20_otu_table_0.1_edited_taxonomies.csv") #this is the new contaminant-free table
...
otus_with_models_V1.to_csv("05.01.20_OTUs_with_models_V1_taxonomy_fixed.csv")
otus_with_models_V2.to_csv("05.01.20_OTUs_with_models_V2_taxonomy_fixed.csv")
otus_with_low_tax_ids.to_csv("05.01.20_OTUs_with_low_tax_ids_taxonomy_fixed.csv")
