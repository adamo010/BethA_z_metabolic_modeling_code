...
#NOTE here that we're using Hale2018 and Niccolai2020 Carved models- 
precarveme = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Hale_2018_model_picking/07.29.21_Hale2018_Carved_model_taxonomy.csv")
precarveme2 = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Model_picking/Niccolai_2020_model_picking/10.19.21_Niccolai2020_Carved_model_taxonomy.csv")

#using two different carveme sources, so need to label and merge them.
precarveme['study_name']= "Hale"
precarveme2['study_name']= "Niccolai"

carveme = pd.concat([precarveme, precarveme2])
del precarveme, precarveme2

otus = pd.read_csv("12.02.21_Muehlbauer2021_OTUs_without_mambo_models_single_tax_level_hand_picks.csv") 
...
otus_clean = otus.drop(columns=["Unnamed: 0", 'agora_family_matched_model_list', 'agora_genus_matched_model_list',
       'agora_genus2_matched_model_list', 'agora_species_matched_model_list', 'all_agora_matched_models',
       'mambo_family_matched_model_list', 'mambo_family_matched_model_list_hand_assigned', 'mambo_genus_new_matched_model_list',
       'mambo_genus_extracted_matched_model_list', 'all_mambo_matched_models', 'mambo_genus_new_matched_model_list',
...
list_of_cols = ["carveme_family_matched_model_list", "carveme_genus_matched_model_list", "carveme_species_matched_model_list"]
...
otus_plus_tax_plus_models["all_carveme_matched_models"] = otus_plus_tax_plus_models["carveme_family_matched_model_list"] + \
    otus_plus_tax_plus_models["carveme_genus_matched_model_list"] + otus_plus_tax_plus_models["carveme_species_matched_model_list"]
...
#SAVE
otus_with_carveme_models.to_csv("12.03.21_Muehlbauer2021_OTUs_with_carveme_models.csv")
otus_without_carveme_models.to_csv("12.03.21_Muehlbauer2021_OTUs_without_models.csv")
