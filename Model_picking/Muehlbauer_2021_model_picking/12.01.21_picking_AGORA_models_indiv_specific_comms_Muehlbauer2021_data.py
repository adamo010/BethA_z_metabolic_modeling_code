...
otus = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Contaminant_removal/12.01.21_Muehlbauer2021_asv_table_abundance_filtered_0.1_any_sample_cutoff.csv") #this is the new contaminant-free table
...
#LAME, I have to add back species level here. 
...
taxonomy_table = pd.read_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Published_data/ASV_tables_Muehlbauer2021/Muehlbauer2021_OTUs_with_matched_taxonomy.csv")
taxonomy_table = taxonomy_table.rename({'Unnamed: 0': 'OTU_ID'}, axis='columns')
...
taxonomy_table.drop(taxonomy_table.columns[1:13], axis=1, inplace=True)
...
#I don't THINK the below issue is an issue with Muehlbauer data, but I guess we'll find out. 
...
#["Genus"] = genus2_matched_models["Genus"].apply(convert_to_list)
...
otus_with_models_V1.to_csv("12.01.21_Muehlbauer2021_OTUs_with_models_V1_indiv_specific_comms.csv")
otus_with_models_V2.to_csv("12.01.21_Muehlbauer2021_OTUs_with_models_V2_indiv_specific_comms.csv")
otus_with_low_tax_ids.to_csv("12.01.21_Muehlbauer2021_OTUs_with_low_tax_ids.csv")
otus_without_family_models.to_csv("12.01.21_Muehlbauer2021_OTUs_without_models_V1_indiv_specific_comms.csv") 
otus_without_family2_models.to_csv("12.01.21_Muehlbauer2021_OTUs_without_models_V2_indiv_specific_comms.csv") 
