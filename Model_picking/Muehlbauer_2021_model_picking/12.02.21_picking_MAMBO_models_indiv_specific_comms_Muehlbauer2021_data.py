...
otus = pd.read_csv("12.01.21_Muehlbauer2021_OTUs_without_models_V1_indiv_specific_comms.csv") #this is the new contaminant-free table
...
otus_plus_tax = otus_plus_tax.drop(columns={"species_matched_model_list", "genus_matched_model_list", "family_matched_model_list"})
...
otus_with_models_V1.to_csv("12.02.21_Muehlbauer2021_OTUs_with_MAMBO_models_V1_indiv_specific_comms.csv")
otus_with_models_V2.to_csv("12.02.21_Muehlbauer2021_OTUs_with_MAMBO_models_V2_indiv_specific_comms.csv")
#otus_with_low_tax_ids.to_csv("12.02.21_Muehlbauer2021_OTUs_with_MAMBO_low_tax_ids.csv") #commenting this out
otus_without_family_models.to_csv("12.02.21_Muehlbauer2021_OTUs_without_MAMBO_models_V1_indiv_specific_comms.csv") 
otus_without_family2_models.to_csv("12.02.21_Muehlbauer2021_OTUs_without_MAMBO_models_V2_indiv_specific_comms.csv") 
