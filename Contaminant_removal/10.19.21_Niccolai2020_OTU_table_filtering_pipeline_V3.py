...
#as of 10.15.21- NEW contaminant dataset
#as of 10.19.21- NEW contaminant dataset
...
contaminants = pd.read_csv("10.18.21_multistudy_contaminant_list_V2.txt", sep="/t", header = None, engine='python') #new contaminants list
...
#save both of these.
taxsplit_otus_filtered.to_csv("10.19.21_Niccolai2020_OTUs_contaminants_removed_V3.csv")
taxsplit_otus_contaminants_all.to_csv("10.19.21_Niccolai2020_OTUs_contaminant_taxa_V3.csv")
...
taxsplit_otus.to_csv("/Users/adamo010/Documents/MICOM_CRC_FBA/Published_data/CRC_OTU_tables_Niccolai2020/Niccolai_2020_OTUs_with_matched_taxonomy_V3.csv")
...
otu_table_relabund_above_cutoff_plus_taxonomy.to_csv("10.19.21_Niccolai2020_otu_table_abundance_filtered_0.1_V3.csv")
otu_table_relabund_below_cutoff_plus_taxonomy.to_csv("10.19.21_Niccolai2020_otu_table_below_0.1_abundance_taxa_V3.csv")
...
#save 
otu_table_relabund_filtered.to_csv("10.19.21_Niccolai2020_otu_table_abundance_filtered_0.1_any_sample_cutoff.csv")
