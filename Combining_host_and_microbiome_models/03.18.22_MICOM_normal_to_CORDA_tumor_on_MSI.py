...
#we are ONLY running normal microbiome and tumor human samples here today.
def main():
    script = sys.argv[0]
    ...
    for key, value in host_model_dict.items():
        ...
        microbiome_plus_host_name = str("PBID_"+str(host_PBID)+"_tumor_host_"+str(human_model_id)+"_normal_microbiome_"\
