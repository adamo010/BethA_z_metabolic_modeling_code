...
def main():
    ...
    metadata_subset= all_metadata[all_metadata["Pair_type"]=="tumor_tumor"] #CHANGE WITH EACH script
    ...
    for file in os.listdir():
    	if str("_tumor_hostmodel_EUstd_spent_medium.csv") in str(file): #CHANGE ME when using tumor/normal host
    ...
    for key, value in microbiome_model_dict.items():
        ...
        host_plus_microbiome_name = str("PBID_"+str(microbiome_PBID)+"_tumor_microbiome_"+str(microbiome_model_id)+"_tumor_host_"\
        ...
        fluxes["host_model_description"] = "tumor" #CHANGE WITH EACH script
        ...
        if microbiome_post_coop_med is None: 
            ...
            microbiome_post_growth_med["host_model_description"] = "tumor" #CHANGE WITH EACH script
