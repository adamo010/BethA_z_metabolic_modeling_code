...
###############STEP 0: file lists and names################ #we are ONLY running normal microbiome and normal human samples here today. 03.25.22_CORDA_normal_to_MICOM_normal_on_MSI.py
def main():
    script = sys.argv[0]
    ...
    for file in os.listdir():
    	if str("_normal_hostmodel_EUstd_spent_medium.csv") in str(file):
    ...
    for key, value in microbiome_model_dict.items():
        ...
        host_plus_microbiome_name = str("PBID_"+str(microbiome_PBID)+"_normal_microbiome_"+str(microbiome_model_id)+"_normal_host_"\
        ...
        if microbiome_post_coop_med is None: 
            ...
            microbiome_post_growth_med["microbiome_model_description"] = "normal" #CHANGE WITH EACH script
