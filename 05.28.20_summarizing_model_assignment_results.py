...
contaminant_otus = pd.read_csv("Contaminant_removal/06.04.20_table_of_contaminant_OTUs.csv")
...
otus_with_agora_models1 = pd.read_csv("Model_picking/04.27.20_OTUs_with_models_V1.csv")
otus_with_agora_models2 = pd.read_csv("Model_picking/05.01.20_OTUs_with_models_V1_taxonomy_fixed.csv")
otus_with_mambo_models = pd.read_csv("Model_picking/04.27.20_OTUs_with_mambo_models_V1.csv")   
...
summary_of_all_otus_with_models.to_csv("06.09.20_summary_of_otus_with_models.csv")
...
summary_of_all_otus_without_models.to_csv("06.09.20_summary_of_otus_without_models.csv")

#jeezus fucking christ. Thirteen days to get here. 
