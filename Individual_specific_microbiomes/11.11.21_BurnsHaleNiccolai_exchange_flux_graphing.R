...
##########import data
Burns_data <- read.csv("Analyzing_MICOM_communities_Burns2015/11.08.21_Fusobacterium_exchange_fluxes_only_alldata_Burns2015_data.csv")
Burns_stats <- read.csv("Analyzing_MICOM_communities_Burns2015/11.08.21_Fusobacterium_exchange_fluxes_only_stats_Burns2015_data.csv")
Hale_data <- read.csv("Analyzing_MICOM_communities_Hale2018/11.09.21_Fusobacterium_exchange_fluxes_only_alldata_Hale2018_data.csv")
Hale_stats <- read.csv("Analyzing_MICOM_communities_Hale2018/11.09.21_Fusobacterium_exchange_fluxes_only_stats_Hale2018_data.csv")
Niccolai_data <- read.csv("Analyzing_MICOM_communities_Niccolai2020/11.10.21_Fusobacterium_exchange_fluxes_only_alldata_Niccolai2020_data.csv")
Niccolai_stats <- read.csv("Analyzing_MICOM_communities_Niccolai2020/11.10.21_Fusobacterium_exchange_fluxes_only_stats_Niccolai2020_data.csv")
