...
#and 09.16.21_Burns2015_fluxpath_analysis_at_subsystem_level.R
...
write.csv(as.data.frame(fluxpath_statistics), file="09.29.21_filtered_median_microbial_flux_subsystems_all_results_Burns2015_data.csv")
...
write.csv(as.data.frame(fluxpath_statistics_sig), file="09.29.21_filtered_median_microbial_flux_subsystems_SIG_results_Burns2015_data.csv")
...
write.csv(as.data.frame(analyzed_fluxpaths_paired_wide), file="09.29.21_filtered_median_microbial_flux_subsystems_all_data_Burns2015_data.csv")
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Terpenoid backbone biosynthesis")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Terpenoid backbone biosynthesis subsystem\n median flux, Burns2015 data"), subtitle = expression("paired Wilcoxan, p=0.00850, q= 0.159")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5), plot.margin = unit(c(1,0.1,0.1,0.1), "cm")) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Vitamin B6 metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Vitamin B6 metabolism subsystem\n median flux, Burns2015 data"), subtitle = expression("paired Wilcoxan, p=0.00979, q= 0.159")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5), plot.margin = unit(c(1,0.1,0.1,0.1), "cm")) +
...
#Purine catabolism
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Purine catabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Purine catabolism subsystem\n median flux, Burns2015 data"), subtitle = expression("paired Wilcoxan, p=0.0429, q= 0.395")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5), plot.margin = unit(c(1,0.1,0.1,0.1), "cm")) +
  scale_y_continuous(name = "Median flux,\nmmol/(gDW * h)", limits=c(0,1000)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Vitamin B2 metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Vitamin B2 metabolism subsystem\n median flux, Burns2015 data"), subtitle = expression("paired Wilcoxan, p=0.0479, q= 0.395")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5), plot.margin = unit(c(1,0.1,0.1,0.1), "cm")) +
  scale_y_continuous(name = "Median flux,\nmmol/(gDW * h)", limits=c(0,250)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
...
#Thiamine metabolism
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Thiamine metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Thiamine metabolism subsystem\n median flux, Burns2015 data"), subtitle = expression("paired Wilcoxan, p=0.0492, q= 0.395")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5), plot.margin = unit(c(1,0.1,0.1,0.1), "cm")) +
  scale_y_continuous(name = "Median flux,\nmmol/(gDW * h)", limits=c(0,1000)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
