...
#note here that we're only doing tumor GRs, because taht's all we care about at this point.
...
write.csv(as.data.frame(sig_corr_p_values_uncorrected_long ), file="09.13.21_Burns2015_filtered_uncorr_GR_and_tumor_metabolic_GE_only_correlations_pvalues.csv") #save this to csv
...
#GRAPH 1
ggplot(grs_and_ges_combined, aes(x=Porphyromonadaceae_Porphyromonas, y=MTHFD2)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("MTHFD2 vs. "*italic("Porphyromonas")), subtitle= expression("Spearman correlation p = 0.000612")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Porphyromonas,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "MTHFD2,\nlog2(fold change gene expression)") 

#GRAPH 2
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=DTYMK)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("DTYMK vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00121")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "DTYMK,\nlog2(fold change gene expression)") 

#GRAPH 3
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=TARS2)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("TARS2 vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00221")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "TARS2,\nlog2(fold change gene expression)") 

#GRAPH 4
ggplot(grs_and_ges_combined, aes(x=Propionibacteriaceae_Propionibacterium, y=PTGS1)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("PTGS1 vs. "*italic("Propionibacterium")), subtitle= expression("Spearman correlation p = 0.00386")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Propionibacterium,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "PTGS1,\nlog2(fold change gene expression)") 

#GRAPH 5
ggplot(grs_and_ges_combined, aes(x=Rikenellaceae_Blvii28, y=DPAGT1)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("DPAGT1 vs. "*italic("Blvii28")), subtitle= expression("Spearman correlation p = 0.00420")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Blvii28,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "DPAGT1,\nlog2(fold change gene expression)") 

#GRAPH 6
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=ADCY9)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("ADCY9 vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00445")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "ADCY9,\nlog2(fold change gene expression)") 

#GRAPH 7
ggplot(grs_and_ges_combined, aes(x=Prevotellaceae_Prevotella, y=ASPA)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("ASPA vs. "*italic("Prevotella")), subtitle= expression("Spearman correlation p = 0.00466")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Prevotella,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "ASPA,\nlog2(fold change gene expression)") 

#GRAPH 8
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=RRM2)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("RRM2 vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00479")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "RRM2,\nlog2(fold change gene expression)") 

#GRAPH 9
ggplot(grs_and_ges_combined, aes(x=Prevotellaceae_Prevotella, y=TARS2)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("TARS2 vs. "*italic("Prevotella")), subtitle= expression("Spearman correlation p = 0.00601")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Prevotella,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "TARS2,\nlog2(fold change gene expression)") 
...
#GRAPH 10
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=BUB1B)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("BUB1B vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00621")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
...
#GRAPH 11
ggplot(grs_and_ges_combined, aes(x=Prevotellaceae_Prevotella, y=MUSK)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("MUSK vs. "*italic("Prevotella")), subtitle= expression("Spearman correlation p = 0.00647")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Prevotella,\nlog2(tumor growth rate)") +
  scale_y_continuous(name = "MUSK,\nlog2(fold change gene expression)") 

#GRAPH 12
ggplot(grs_and_ges_combined, aes(x=Ruminococcaceae_Oscillospira, y=PPAT)) + 
  geom_point() +
  geom_smooth(method=lm) +
  labs(title = expression("PPAT vs. "*italic("Oscillospira")), subtitle= expression("Spearman correlation p = 0.00713")) +
  theme(plot.title = element_text(hjust=0.5, vjust=2, size=12), plot.subtitle = element_text(hjust = 0.5, vjust =1, size=12)) +
  guides(fill="none") +
  scale_x_continuous(name ="Oscillospira,\nlog2(tumor growth rate)") +
