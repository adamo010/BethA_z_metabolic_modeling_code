...
exported_metabs_top_diffs_cleaned <- subset(exported_metabs_top_diffs, select = -c(...1, sorting_col, diff, Difference_direction, 
                                                                                   normal, tumor, log2_metabs_normal, log2_metabs_tumor) )
imported_metabs_top_diffs_cleaned <- subset(imported_metabs_top_diffs, select = -c(...1, sorting_col, diff, Difference_direction, 
                                                                                   normal, tumor, log2_metabs_normal, log2_metabs_tumor) )
#cleanup
...
#save data
write.csv(as.data.frame(export_sig_corr_p_values_uncorrected_long), file="09.17.21_Burns2015_filtered_uncorr_change_in_exported_metabs_and_tumor_metabolic_GE_only_correlations_pvals.csv") #save this to csv
write.csv(as.data.frame(import_sig_corr_p_values_uncorrected_long), file="09.17.21_Burns2015_filtered_uncorr_change_in_imported_metabs_and_tumor_metabolic_GE_only_correlations_pvals.csv") #save this to csv
