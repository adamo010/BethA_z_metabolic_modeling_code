...
#09.02.21_Hale2018_inputoutputs_combining_files_and_adding_metadata.py
#tradeoff = 0.1)
...
filelist = glob.glob('*_V30_Burns_fluxes_on_input_output.csv') #why haven't I been doing this forever? this creates a list of files with the specified string

#make a list of sample names, a list of dataframes, and a dictionary of both of these together. 
sample_names_list = []
for file in filelist:
    sample_name = re.sub("_V30_Burns_fluxes_on_input_output.csv", "", file) #delete extra crap on string.  
...
#double check here that all metabolites have their names assigned. Looks like we're all good here! Include extra steps but comment them out.
...
combo_metab_df3_plus_metadata.drop(['SampleID', 'Site', 'MSI_status', 'Stage'], axis=1, inplace=True)#drop superfluous columns
#export!
...
combo_metab_df3_plus_metadata.to_csv("09.09.21_Burns2015_inputoutput_with_metadata_longform.csv")
