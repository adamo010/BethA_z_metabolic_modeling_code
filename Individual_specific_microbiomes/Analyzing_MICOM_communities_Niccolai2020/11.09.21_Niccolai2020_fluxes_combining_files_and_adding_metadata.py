...
#INTERESTING:  192 fluxpaths for Burns, 324 for Hale, 217 for Niccolai
...
combo_fluxpath_df_plus_metab_sample_metadata = pd.merge(left=combo_fluxpath_plus_metab_metadata, right=metadata, 
                                                        how='left', left_on='Sample_ID', right_on='Sample_ID') #merge metadata
combo_fluxpath_df_plus_metab_sample_metadata.drop(['SampleID', 'Age', 'Diagnosis', 'TNM', 'Statium', 'Site'], axis=1, inplace=True)#drop superfluous columns
...
combo_fluxpath_df_plus_metab_sample_metadata.to_csv("11.09.21_Niccolai2020_fluxes_with_metadata_longform.csv")
