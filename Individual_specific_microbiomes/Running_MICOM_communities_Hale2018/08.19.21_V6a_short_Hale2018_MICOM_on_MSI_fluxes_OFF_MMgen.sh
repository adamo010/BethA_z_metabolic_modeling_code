...
file=$(awk "NR==${SLURM_ARRAY_TASK_ID}" Hale2018_pickle_file_sublist_remaining_after_sublist1.txt)
python 08.19.21_V6_short_Hale2018_MICOM_on_MSI_fluxes_OFF_MMgen.py $file
