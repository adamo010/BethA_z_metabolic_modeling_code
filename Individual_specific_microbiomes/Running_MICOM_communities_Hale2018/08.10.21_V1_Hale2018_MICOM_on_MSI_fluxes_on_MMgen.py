...
def main():
    ...
    sample_sol = imported_pickle_model.cooperative_tradeoff(min_growth=0, fraction=0.15, fluxes=True, pfba=True) 
    ...
    for file in os.listdir():
        ...
        if fnmatch.fnmatch(file, "_V1_Hale_MSIgen_MM_from_model.csv"):
            ...
            dst=str(pickle_file_sample_name)+file
            os.rename(src,dst)
        elif fnmatch.fnmatch(file, "_V1_Hale_input_output.csv"):
        	dst=str(pickle_file_sample_name)+file
        	os.rename(src,dst)    
        	...
        	os.rename(src,dst)	
    #del src,file,dst 
    #del imported_pickle_model, imported_pickle_model2, infile 
