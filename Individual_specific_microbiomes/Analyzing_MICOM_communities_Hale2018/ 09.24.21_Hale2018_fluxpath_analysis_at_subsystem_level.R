...
analyzed_fluxpaths_wide <- analyzed_fluxpaths_wide %>% 
  spread(normal_adjacent_or_tumor_tissue_specimen, av_fluxpath_amount)
...
write.csv(as.data.frame(fluxpath_statistics), file="09.24.21_filtered_microbial_flux_subsystems_all_results_Hale2018_data.csv")
...
write.csv(as.data.frame(fluxpath_statistics_sig), file="09.24.21_filtered_microbial_flux_subsystems_SIG_results_Hale2018_data.csv")
