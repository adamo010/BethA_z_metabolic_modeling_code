...
#based on combining 01.04.22_Burns2015_Fuso_fluxpath_analysis_at_subsystem_level.R 
#and 12.21.21_Hale2018_Fuso_fluxpath_analysis_exchanges_only_newfilter2.R
...
analyzed_fluxpaths <- read_csv("01.07.22_Hale2018_Fuso_fluxes_with_metadata_longform.csv") 
...
analyzed_fluxpaths_filtered <- filter(analyzed_fluxpaths_filter_added, n >= 23)
...
write.csv(as.data.frame(fluxpath_statistics), file="01.07.22_Fusobacterium_flux_subsystems_stats_Hale2018_data.csv")
...
fuso_fluxpaths_abundance_filtered <- filter(fuso_fluxpaths_filter_added, n >= 46)
...
write.csv(as.data.frame(fuso_fluxpath_statistics2), file="01.07.22_Fusobacterium_all_flux_stats_Hale2018_data.csv")
