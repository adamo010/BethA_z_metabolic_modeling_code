...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  2 11:00:35 2021
...
#starting point: V02.04.21_combining_species_specific_GRs_over_TD_values.py
#tradeoff = 0.1)
...
filelist = glob.glob('*_V12_Hale_input_output.csv') #why haven't I been doing this forever? this creates a list of files with the specified string

#make a list of sample names, a list of dataframes, and a dictionary of both of these together. 
sample_names_list = []
for file in filelist:
    sample_name = re.sub("_V12_Hale_input_output.csv", "", file) #delete extra crap on string.  
...
#double check here that all metabolites have their names assigned. For this dataset, three do NOT. May have to hand-add these.
...
combo_metab_df3= copy.deepcopy(combo_metab_df2)
combo_metab_df3= combo_metab_df2.set_index('longform_metabolite_names')
...
combo_metab_df3_flipped_longform = pd.merge(left=combo_metab_df3_flipped_longform , right=metab_key_slimmed_plus_missing, how='left', 
...
combo_metab_df3_plus_metadata = pd.merge(left=combo_metab_df3_flipped_longform, right=metadata, 
                                                        how='left', left_on='SampleID', right_on='sampleIDs_from_read_counts') #merge metadata
combo_metab_df3_plus_metadata.drop(["cancer_stage", "env_material", "ethnicity", "Host_Age", "host_body_mass_index", "sampleIDs_from_read_counts",\
...
#export!
os.chdir("/Users/adamo010/Documents/MICOM_CRC_FBA/Individual_specific_microbiomes/Analyzing_MICOM_communities_Hale2018/")
combo_metab_df3_plus_metadata.to_csv("09.02.21_Hale2018_inputoutput_with_metadata_longform.csv")
